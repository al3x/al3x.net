...
I currently work as an engineer for "Twitter, Inc.":http://twitter.com, a communications service that allows users to send short one-to-many messages via a variety of media. I've been working at Twitter since the beginning of 2007, several months before the service began to grow in popularity. It's been an education in scaling, optimization, and systems architecture, not to mention all the joys and stresses that come with working at a startup. I worked for some time building Twitter's developer platform. I now work on the service's back-end infrastructure,

Before Twitter I worked in information security for a military and intelligence contractor, built web applications for political campaigns and non-profits, and more. I've been working in technology since before I was old enough to legally hold a work permit. I was twelve when I did my first software development internship.
...
* "Open Ideas":http://ideas.al3x.net/ -- sketches of projects I may or may not pursue.
* "Graceless Failures":http://www.gracelessfailures.com/ -- tips and tricks for the Scala programming language.
* "Minima":http://minima.al3x.net/ -- a record of applied simplicity, now ended.
