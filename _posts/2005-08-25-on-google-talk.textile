...
I could see Talk getting interesting if their next version works on multiple platforms, actually has significant interface improvements over other IM clients, and bridges networks (Google Talk <=> AIM, or Google Talk <=> MSN, for example).
