...
If there's one thing I'm convinced of at the end of this exploration is that there's more work to be done, and more businesses to emerge in this field. Social networks alone aren't focused enough tools to bubble up and share quality content. My hope is that through a surplus open data of the sort we're trying hard to share at "Twitter":http://apiwiki.twitter.com/, a new generation of tools to manage the flood of content will emerge. I don't think it's a problem that Twitter, or any other pipeline for information, can solve on its own.
